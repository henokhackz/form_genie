  ...
  return (
    <div className='p-10'>
      <div className='flex justify-between items-center'>
        ...
        <div className='flex gap-2'>
          <Link href={'/aiform/' + record?.id} target="_blank">
            <Button className="flex gap-2 hover:bg-neomorphic-primary-light" > <SquareArrowOutUpRight className='h-5 w-5' /> Live Preview</Button>
          </Link>
          <RWebShare
            data={{
      ...
      <div className='grid grid-cols-1  md:grid-cols-3 gap-5'>
        <div className='p-5 border border-gray-300 rounded-2xl shadow-md'>
          <Controller
            selectedTheme={(value) => {
        ...
        <div className='md:col-span-2 border border-gray-300 rounded-lg p-5 
