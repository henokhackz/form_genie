...
function FieldEdit({defaultValue,onUpdate,deleteField}) {
  ...
  <AlertDialogContent className="bg-white text-gray-800">
    ...
    <AlertDialogFooter>
      <AlertDialogCancel className="mr-2 bg-transparent hover:bg-gray-100 border-none">Cancel</AlertDialogCancel>
      <AlertDialogAction onClick={()=>deleteField()} className="bg-red-500 hover:bg-red-600 text-white">Continue</AlertDialogAction>
    </AlertDialogFooter>
  </AlertDialogContent>
</AlertDialog>
